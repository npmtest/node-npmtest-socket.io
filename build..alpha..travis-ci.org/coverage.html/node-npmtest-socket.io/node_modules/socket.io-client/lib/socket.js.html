...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-socket.io/node_modules/socket.io-client/lib/socket.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-socket.io/node_modules/socket.io-client/lib/socket.js</span></h1>
    <h2>
        
        Statements: <span class="metric">18.24% <small>(29 / 159)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">19.08% <small>(29 / 152)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-socket.io/node_modules/socket.io-client/lib/</a> &#187; socket.js</div>
</div>
<div class="body">
...
419
420
421</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function Socket (io, nsp, opts) {</span>
...
<span class="cstat-no" title="statement not covered" >  this.json = this; </span>// compat
...
<span class="cstat-no" title="statement not covered" >  this.receiveBuffer = [];</span>
<span class="cstat-no" title="statement not covered" >  this.sendBuffer = [];</span>
...
<span class="cstat-no" title="statement not covered" >  if (opts &amp;&amp; opts.query) {</span>
<span class="cstat-no" title="statement not covered" >    this.query = opts.query;</span>
  }
<span class="cstat-no" title="statement not covered" >  if (this.io.autoConnect) <span class="cstat-no" title="statement not covered" >this.open();</span></span>
}
&nbsp;
/**
 * Mix in `Emitter`.
 ...
 */
&nbsp;
Socket.prototype.subEvents = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  if (this.subs) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var io = this.io;</span>
...
Socket.prototype.connect = <span class="fstat-no" title="function not covered" >function () {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.subEvents();</span>
<span class="cstat-no" title="statement not covered" >  this.io.open(); </span>// ensure open
<span class="cstat-no" title="statement not covered" >  if ('open' === this.io.readyState) <span class="cstat-no" title="statement not covered" >this.onopen();</span></span>
<span class="cstat-no" title="statement not covered" >  this.emit('connecting');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  packet.options = {};</span>
<span class="cstat-no" title="statement not covered" >  packet.options.compress = !this.flags || false !== this.flags.compress;</span>
&nbsp;
  // event ack callback
...
<span class="cstat-no" title="statement not covered" >    this.sendBuffer.push(packet);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (this.query) {</span>
<span class="cstat-no" title="statement not covered" >      this.packet({type: parser.CONNECT, query: this.query});</span>
    } else {
...
<span class="cstat-no" title="statement not covered" >  this.connected = false;</span>
<span class="cstat-no" title="statement not covered" >  this.disconnected = true;</span>
<span class="cstat-no" title="statement not covered" >  delete this.id;</span>
...
<span class="cstat-no" title="statement not covered" >    this.receiveBuffer.push(args);</span>
  }
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  for (i = 0; i &lt; this.receiveBuffer.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >    emit.apply(this, this.receiveBuffer[i]);</span>
  }
<span class="cstat-no" title="statement not covered" >  this.receiveBuffer = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (i = 0; i &lt; this.sendBuffer.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >    this.packet(this.sendBuffer[i]);</span>
  }
<span class="cstat-no" title="statement not covered" >  this.sendBuffer = [];</span>
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  if (this.subs) {</span>
...
<span class="cstat-no" title="statement not covered" >    this.subs = null;</span>
  }
&nbsp;
...
Socket.prototype.disconnect = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  if (this.connected) {</span>
